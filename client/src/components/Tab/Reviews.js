...
const Reviews = ({ productId, userId }) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        if (!user) {
            notificationService.warning("Vui lòng đăng nhập để gửi đánh giá!");
            return;
        }
        ...
        try {
            ...
            if (res.ok) {
                notificationService.success("Đánh giá đã được gửi!");
            ...
            console.error(err);
            notificationService.error("Lỗi kết nối đến server!");
        } finally {
            setLoading(false);
        }
    };
                        ...
                        <div key={star} className="rating-bar">
                            ...
                            <div className="bar">
                                <div
                                    className="fill"
                                    style={{
                                        width: `${ratingStats.distribution[star - 1]}%`,
                                    }}
                                />
                            </div>
