...
export default function SliderAdmin() {
    ...
    const fetchSliders = async () => {
        ...
        try {
            ...
            notificationService.error("Không thể tải danh sách slider.");
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleSave = async (e) => {
        ...
        try {
            if (editing) {
                ...
                notificationService.success("Cập nhật slider thành công");
            } else {
                if (
                    !selectedFile &&
            ...
            notificationService.error("Có lỗi xảy ra khi lưu slider: " + msg);
        }
    };
    ...
    const handleDelete = async (id) => {
        ...
        try {
            ...
            notificationService.error("Có lỗi khi xóa slider.");
        }
    };
    ...
    const toggleStatus = async (s) => {
        try {
            ...
            notificationService.error("Không thể đổi trạng thái.");
        }
    };
                            ...
                            >
                                ...
                                >
                                    <h2 className={styles.modalTitle}>
                                        {editing ? "Sửa Slider" : "Thêm Slider"}
                                    </h2>
