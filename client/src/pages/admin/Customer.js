...
export default function CustomerList() {
    ...
    const fetchCustomers = async () => {
        ...
        try {
            ...
            notificationService.error("Không thể tải danh sách khách hàng.");
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleDelete = async (id) => {
        ...
        try {
            ...
            notificationService.error("Có lỗi xảy ra khi xoá khách hàng.");
        }
    };
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            notificationService.error("Có lỗi xảy ra khi cập nhật khách hàng.");
        }
    };
