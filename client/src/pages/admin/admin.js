...
export default function AdminList() {
  ...
  const handleCreate = async (e) => {
    ...
    if (!formData.name || !formData.email || !formData.password) {
      alert("Vui lòng điền tên, email và password.");
      return;
    }
    try {
      ...
      alert(err.response?.data?.message || "Có lỗi khi tạo admin.");
    }
  };
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      alert(err.response?.data?.message || "Có lỗi khi cập nhật admin.");
    }
  };
      ...
      <div className="grid__row">
        ...
        <div className="grid__column-10">
          ...
          <div className={styles.wrapper}>
            <h1 className={styles.title}>Quản lý nhân viên nội bộ</h1>
          ...
          {showAddModal && (
            ...
            >
              ...
              >
                <h2 className={styles.modalTitle}>Thêm nhân viên</h2>
                ...
                <form className={styles.form} onSubmit={handleCreate}>
                  ...
                  <div className={styles.modalActions}>
                    ...
                    <button type="button" className={styles.cancelBtn} onClick={closeAddModal}>Huỷ</button>
                  </div>
                </form>
              </div>
            </div>
          ...
          {editingAdmin && (
            ...
            >
              <div
                ...
                onClick={(e) => e.stopPropagation()}
              >
                <h2 className={styles.modalTitle}>Sửa nhân viên</h2>
                ...
                <form className={styles.form} onSubmit={handleUpdate}>
                  ...
                  <div className={styles.modalActions}>
                    ...
                    <button type="button" className={styles.cancelBtn} onClick={closeEditModal}>Huỷ</button>
                  </div>
                </form>
              </div>
            </div>
